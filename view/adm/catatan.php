<h3 class='page-header'>Catatan Kegiatan Siswa Prakerin</h3>
			...
			if ($conn->query($sql)->num_rows!==0) {
				...
				while ($get_siswa = $query_siswa->fetch_assoc()) {
					...
					echo "<tr>
							...
							<td>$name</td>
							<td>$school</td>
							<td><a class='btn btn-primary' href='catatan&id_siswa=$id_siswa' title='Catatan $name'>Lihat Kegiatan</a></td>
						</tr>";
				}
				$conn->close();
				echo "</tbody></table>";
