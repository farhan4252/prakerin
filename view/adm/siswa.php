<h3 class='page-header'>Daftar Siswa Prakerin</h3>
<?php 
if (isset($_GET['st'])) {
        if ($_GET['st']==1) {
            ...
            echo "<table class='table table-striped' style='width:70%'>
                    ...
                    while ($get_siswa = $query_siswa->fetch_assoc()) {
                        ...
                        echo "<tr>
                                ...
                                <td><a class='btn btn-primary' href='siswa&id_siswa=$id_siswa' title='Edit $name'>Edit Siswa</a> &bullet; <a class='btn btn-danger' style='cursor:pointer' onclick='hapusSiswa($id_siswa)' >Hapus Siswa</a></td>
                            </tr>";
                    }
                   // $conn->close();
                    echo "</tbody></table>";
