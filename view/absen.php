<h1 class="page-header">ABSENSI HARI INI</h1>
<?php
...
echo 	"<tr>
        ...
        <td><button type='button' class='btn btn-primary' onclick=\"window.location.href='./model/proses.php?absen=2';\" $disable_out>Absen Pulang</button></td>
        </tr>";
echo "</table></div>";
?>